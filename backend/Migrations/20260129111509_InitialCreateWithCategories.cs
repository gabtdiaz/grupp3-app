    ...
    public partial class InitialCreateWithCategories : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "DisplayName", "IconUrl", "IsActive", "Name", "SortOrder" },
                values: new object[,]
                {
                    { 1, "RÖRELSE", "/icons/sport-icon.svg", true, "Rorelse", 1 },
                    { 2, "SOCIALT", "/icons/social-icon.svg", true, "Socialt", 2 },
                    { 3, "SPEL", "/icons/games-icon.svg", true, "Spel", 3 },
                    { 4, "KULTUR", "/icons/culture-icon.svg", true, "Kultur", 4 },
                    { 5, "MAT & DRYCK", "/icons/food-icon.svg", true, "MatOchDryck", 5 },
                    { 6, "UTOMHUS", "/icons/outdoor-icon.svg", true, "Utomhus", 6 },
                    { 7, "MUSIK", "/icons/music-icon.svg", true, "Musik", 7 },
                    { 8, "STUDIER", "/icons/study-icon.svg", true, "Studier", 8 },
                    { 9, "ÖVRIGT", "/icons/other-icon.svg", true, "Ovrigt", 9 }
                });
