...
namespace grupp3_app.Api.Migrations
{
    ...
    [Migration("20260211121300_AddEventImageToEvent")]
    partial class AddEventImageToEvent
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("grupp3_app.Api.Models.Event", b =>
                {
                    ...
                    b.Property<byte[]>("EventImageData")
                        .HasColumnType("varbinary(max)");

                    b.Property<string>("EventImageFileType")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("grupp3_app.Api.Models.User", b =>
                {
                    ...
                    b.Property<string>("ProfileImageFileType")
                        .HasColumnType("nvarchar(max)");
